...
// // Attendance ab "children" ke saath hai — isse submenu banega
// const NAV = [
...
// // Ek group (jiske children hain) ke liye expandable menu item
// function NavGroup({ item, onNavigate }) {
//   const location = useLocation();
//   // agar current URL is group ke kisi child se match karta hai to shuru mein hi khula rahega
